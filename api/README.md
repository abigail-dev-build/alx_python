...
Welcome developers, in this project, we are working with rest api's in python to get data and modify them.

To successfully have access to this project code, do follow the instructions below.

### Instructions

- Open your web browser and go to the GitHub repository: https://github.com/abigail-dev-build/alx_pyhton
...
- After cloning, you can navigate into the cloned repository directory using the cd command. For example, the repository is named "alx_python", use: 'cd api'
