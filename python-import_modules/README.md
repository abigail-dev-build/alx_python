...
- After cloning, you can navigate into the cloned repository directory using the cd command. For example, the repository is named "alx_python", use: 'cd python-import_modules'
- To get into the html advanced directory we are working in, use the command 'cd python-import_modules'
