...
- Open your web browser and go to the GitHub repository: https://github.com/abigail-dev-build/alx_python
...
- After cloning, you can navigate into the cloned repository directory using the cd command. For example, the repository is named "alx_python", use: 'cd python-more_data_structures'
- To get into the html advanced directory we are working in, use the command 'cd python-more_data_structures'
